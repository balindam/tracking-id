...
const pool = mysql.createPool({
  connectionLimit: 100, // adjust this according to your needs
...
// Promisify the pool query function for use with async/await
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    if (ipExists.length > 0) {
      ...
      await pool.query(insertQuery, [hash, user, ip]);
    }
